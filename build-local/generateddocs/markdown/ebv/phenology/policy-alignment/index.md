...
```jsonld
{
  "@context": "http://localhost:9090/register/build-local/annotated/ebv/phenology/policy-alignment/context.jsonld",
  "type": "PolicyAlignment",
  "title": "Policy alignment for Finland EBV phenology data",
  "description": "Illustrative policy alignment record for the EBV phenology dataset 'Vegetation Phenology in Finland'. The record explains how the dataset may support policy-relevant monitoring, while clearly distinguishing between technical interoperability examples and policy-grade indicators.",
  "source_dataset": {
...
* YAML version: [schema.yaml](http://localhost:9090/register/build-local/annotated/ebv/phenology/policy-alignment/schema.json)
* JSON version: [schema.json](http://localhost:9090/register/build-local/annotated/ebv/phenology/policy-alignment/schema.yaml)
...
[context.jsonld](http://localhost:9090/register/build-local/annotated/ebv/phenology/policy-alignment/context.jsonld)
