...
Full-resolution 50 × 50 CoverageJSON Grid crop from the original NetCDF, for coniferous forest in 2001. This is intentionally small enough for the Building Blocks examples page.
#### json
```json
{
  "type": "Coverage",
...
```jsonld
{
  "@context": "http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-coverage/context.jsonld",
  "type": "Coverage",
  "domain": {
    "type": "Domain",
    "domainType": "Grid",
...
* YAML version: [schema.yaml](http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-coverage/schema.json)
* JSON version: [schema.json](http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-coverage/schema.yaml)
...
[context.jsonld](http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-coverage/context.jsonld)
