...
* YAML version: [schema.yaml](http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-parameter/schema.json)
* JSON version: [schema.json](http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-parameter/schema.yaml)
...
[context.jsonld](http://localhost:9090/register/build-local/annotated/ebv/phenology/covjson-parameter/context.jsonld)
